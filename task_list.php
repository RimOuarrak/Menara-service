			...
			<table class="table tabe-hover table-condensed" id="list">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center">
							<a type="button" class="btn btn-default btn-sm btn-flat border-info wave-effect text-info " aria-expanded="true" data-pid = '<?php echo $row['pid'] ?>' data-tid = '<?php echo $row['id'] ?>'  data-task = '<?php echo ucwords($row['task']) ?>'  href="cprov.php?id=<?php echo $row['id'] ?>">
		                      pdf
		                    </a>
